...
import {SafeAreaView, ScrollView, View, Text, TextInput, TouchableOpacity, StyleSheet, Button } from 'react-native';

function AccountScreen() {
    const [activities, setActivities] = useState(['Paint', 'Football', 'Party', 'Read']);
